...
#ifndef __SENSOR8_IIC_INIT1_H
#define __SENSOR8_IIC_INIT1_H
...
#define		Sensor8_IIC1_GPIO_RCC		RCC_APB2Periph_GPIOA
#define 	Sensor8_IIC1_SDA			GPIO_Pin_7
#define 	Sensor8_IIC1_SCL			GPIO_Pin_6
#define 	Sensor8_GPIO1				GPIOA
/* Private typedef -----------------------------------------------------------*/
// Sensor Commands
...
extern  u8 Sensor8_IIC1_Init(void);                                   	// 管脚初始化
