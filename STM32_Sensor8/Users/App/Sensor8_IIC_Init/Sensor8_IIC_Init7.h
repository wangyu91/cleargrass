...
#define		Sensor8_IIC7_GPIO_RCC		RCC_APB2Periph_GPIOA
#define 	Sensor8_IIC7_SDA			GPIO_Pin_7
#define 	Sensor8_IIC7_SCL			GPIO_Pin_6
#define 	Sensor8_GPIO7				GPIOA
/* Private typedef -----------------------------------------------------------*/
// Sensor Commands
...
extern  u8 Sensor8_IIC7_Init(void);                                   	// 管脚初始化
