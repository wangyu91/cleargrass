...
void Sensor8_IIC6_Delay_us(void);										// us延时
void Sensor8_IIC6_Pin_Init(void);                                       // 管脚初始化
void Sensor8_IIC6_Set_SDA_High(void);                                   // 拉高数据线
void Sensor8_IIC6_Set_SDA_Low(void);                                    // 拉低数据线
void Sensor8_IIC6_Set_SCL_High(void);                                   // 拉高时钟
void Sensor8_IIC6_Set_SCL_Low(void);                                    // 拉低时钟
void Sensor8_IIC6_Set_SDA_Input(void);                                 	// 设置SDA为输入模式
void Sensor8_IIC6_Set_SDA_Output(void);                                	// 设置SDA为输出模式
//void Sensor8_IIC_Set_SCL_Output(void);                                    // 设置SCL为输出模式
u8   Sensor8_IIC6_SDA_Read(void);                                     	// 读取SDA电平
u8   Sensor8_IIC6_SCL_Read(void);                                      	// 读取SCL电平

void Sensor8_IIC6_Variable_Init(void);                                 	// SHT30变量初始化
u8   Sensor8_IIC6_Init(void);                                  			// SHT30端口初始化    
u8   Sensor8_IIC6_Read_Register(SW_IIC_t* IIC_s, u8 Chip_Addr, u16 usRead_Addr, u8* pBuffer, u16 usRead_Len);// 读寄存器
...
* Return         :  None
*******************************************************************************/
void Sensor8_IIC6_Delay_us(void)
{
    STM32_Delay_us(1);
...
* Return         :  1成功 0失败
*******************************************************************************/
void Sensor8_IIC6_Pin_Init(void)
{
...
* Return         :  None
*******************************************************************************/
void Sensor8_IIC6_Set_SDA_High(void)
{
...
* Return         :  None
*******************************************************************************/
void Sensor8_IIC6_Set_SDA_Low(void)
{
...
*******************************************************************************/
u8 Sensor8_IIC6_SDA_Read(void)
{
    return(GPIO_ReadInputDataBit(Sensor8_GPIO6, Sensor8_IIC6_SDA));
...
//    Sensor8_IIC6_s.Dealy                 = Sensor8_IIC_Delay;
    Sensor8_IIC6_s.Delay_us              = Sensor8_IIC6_Delay_us;
//    Sensor8_IIC6_s.Pin_Init              = Sensor8_IIC_Pin_Init;
    Sensor8_IIC6_s.SDA_High              = Sensor8_IIC6_Set_SDA_High;
    Sensor8_IIC6_s.SDA_Low               = Sensor8_IIC6_Set_SDA_Low;
    Sensor8_IIC6_s.SCL_High              = Sensor8_IIC6_Set_SCL_High;
    Sensor8_IIC6_s.SCL_Low               = Sensor8_IIC6_Set_SCL_Low;
    Sensor8_IIC6_s.Set_SDA_Input         = Sensor8_IIC6_Set_SDA_Input; 
    Sensor8_IIC6_s.Set_SDA_Output        = Sensor8_IIC6_Set_SDA_Output; 
//    Sensor8_IIC6_s.Set_SCL_Output        = Sensor8_IIC_Set_SCL_Output;   
    Sensor8_IIC6_s.SDA_Read              = Sensor8_IIC6_SDA_Read; 
