...
#define		Sensor8_IIC6_GPIO_RCC		RCC_APB2Periph_GPIOC
#define 	Sensor8_IIC6_SDA			GPIO_Pin_7
#define 	Sensor8_IIC6_SCL			GPIO_Pin_6
#define 	Sensor8_GPIO6				GPIOC
/* Private typedef -----------------------------------------------------------*/
// Sensor Commands
...
extern  u8 Sensor8_IIC6_Init(void);                                   	// 管脚初始化
