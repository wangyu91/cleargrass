...
extern  u8 SHT30_Init(void);                                   			// 管脚初始化
extern  u8 SHT30_Read_Register(u16 usRead_Addr, u8* pBuffer, u16 usRead_Len);// 读寄存器
extern  u8 SHT30_Write_Register(u8 usWrite_Addr, u8* pBuffer, u8 usWrite_Len);// 写寄存器
