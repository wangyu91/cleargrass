...
void SHT30_Pin_Init(void)
{
    ...
    // 设置管脚为开漏模式
    GPIO_Pin_Config(SHT30_GPIO_RCC, SHT30_SDA|SHT30_SCL, GPIO_Mode_Out_OD, GPIO_Speed_50MHz, SHT30_GPIO);   // SDA|A7脚 SCL|A6脚 开漏输出 速率50MHz 
   // GPIO_Pin_Config(SHT30_GPIO_C, SHT30_SCL, GPIO_Mode_Out_PP, GPIO_Speed_50MHz, SHT30_GPIO);	// SCL A6脚
}
...
{
    SHT30_GPIO->CRL &= 0x0FFFFFFF;										// A组管脚 PIN7[31:28]
    SHT30_GPIO->CRL |= 8 << 28;											// 设为上拉输入模式
}
